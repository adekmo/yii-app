 ...
 */
class Obatt extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('nama_obat, jumlah_obat, harga', 'required'),
			array('jumlah_obat, harga', 'numerical', 'integerOnly'=>true),
			array('nama_obat', 'length', 'max'=>300),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_obat, nama_obat, jumlah_obat, harga', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Obatt the static model class
	 */
